...
abstract final class AppTextStyles {
  ...
  static TextStyle get sectionTitle =>
      GoogleFonts.spaceGrotesk(fontSize: 15, fontWeight: FontWeight.bold);
  ...
  static TextStyle get bodySmall => GoogleFonts.inter(fontSize: 14);

  /// 13 / normal — receipt detail cell text, line item rows.
  static TextStyle get bodyXSmall => GoogleFonts.inter(fontSize: 13);
  ...
  static TextStyle get caption => GoogleFonts.inter(fontSize: 12);
  ...
  static TextStyle get countdownHero =>
      GoogleFonts.inter(fontSize: 52, fontWeight: FontWeight.bold, height: 1.0);
