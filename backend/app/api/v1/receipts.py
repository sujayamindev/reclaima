...
async def list_receipts(
    ...
    status_filter: Optional[ReceiptStatusEnum] = Query(
...
@router.get(
    "/{receipt_id}", response_model=ReceiptResponse, response_model_by_alias=True
)
...
@router.post(
    "/{receipt_id}/upload", response_model=ReceiptResponse, response_model_by_alias=True
)
