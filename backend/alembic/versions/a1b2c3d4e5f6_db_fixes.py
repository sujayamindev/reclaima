...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('warranty_reminders_enabled',  sa.Boolean(), nullable=False, server_default='true'),
        sa.Column('return_reminders_enabled',    sa.Boolean(), nullable=False, server_default='true'),
        sa.Column('ocr_notifications_enabled',   sa.Boolean(), nullable=False, server_default='true'),
    ...
    op.create_index(
        ...
        'user_notification_preferences', ['id'], unique=False,
    )
    op.create_index(
        'ix_user_notification_preferences_user_id',
        'user_notification_preferences', ['user_id'], unique=True,
    )
...
def downgrade() -> None:
    ...
    op.drop_index('ix_user_notification_preferences_id',
                  table_name='user_notification_preferences')
