...
def upgrade() -> None:
    ...
    op.add_column('receipt_line_items', sa.Column('product_name', sa.String(512), nullable=True))
    op.add_column('receipt_line_items', sa.Column('product_category', sa.String(128), nullable=True))
    op.add_column('receipt_line_items', sa.Column('product_image_url', sa.String(2048), nullable=True))
    op.add_column('receipt_line_items', sa.Column('warranty_period_months', sa.Integer(), nullable=True))
    op.add_column('receipt_line_items', sa.Column('warranty_expiry_date', sa.DateTime(timezone=True), nullable=True))
    op.add_column('receipt_line_items', sa.Column('return_period_days', sa.Integer(), nullable=True))
    op.add_column('receipt_line_items', sa.Column('return_expiry_date', sa.DateTime(timezone=True), nullable=True))
...
def downgrade() -> None:
    ...
    op.add_column('receipts', sa.Column('product_category', sa.String(128), nullable=True))
    op.add_column('receipts', sa.Column('product_image_url', sa.String(2048), nullable=True))
    op.add_column('receipts', sa.Column('warranty_period_months', sa.Integer(), nullable=True))
    op.add_column('receipts', sa.Column('warranty_expiry_date', sa.DateTime(timezone=True), nullable=True))
    op.add_column('receipts', sa.Column('return_period_days', sa.Integer(), nullable=True))
    op.add_column('receipts', sa.Column('return_expiry_date', sa.DateTime(timezone=True), nullable=True))

    op.create_index('ix_receipts_warranty_expiry_date', 'receipts', ['warranty_expiry_date'])
    op.create_index('ix_receipts_return_expiry_date', 'receipts', ['return_expiry_date'])
